 ...
 * File ini WAJIB ada di root repo karena Hostinger Git auto-deploy
 * melakukan checkout repo ke public_html. Sumber asli:
 * deploy/hostinger-web/public_html-proxy.php
 */
