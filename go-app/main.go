...
func main() {
	...
	mux.HandleFunc("/api/transactions", cors(handleTransactions))
	mux.HandleFunc("/api/transactions/", cors(handleTransactionByID))
	mux.HandleFunc("/api/dashboard", cors(handleDashboard))
